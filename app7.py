...
def main():
    ...
    # Forecasting Configuration (Kept for future reference but not used in tabs)
    ...
    # Main Content Tabs - Removed Model Training and Future Forecast tabs
    tab1, tab2 = st.tabs([
    ...
    with tab2:
        ...
        **Objective:** Develop hybrid predictive algorithms to forecast long-term solar power output in rural 
        ...
        - **Formula:** Solar Power (kWh) = Irradiance (kWh/m²) × Panel Area (m²) × Efficiency
        - **Panel Area:** Calculated from panel capacity and efficiency
        - **Efficiency Factors:** Temperature, cloud cover, and monsoon season adjustments
        ...
        3. Set solar panel configuration (capacity and efficiency)
        
        ### Step 2: Data Collection
        1. Click "Collect Historical Data"
        2. System automatically fetches data or generates realistic patterns
        3. View collected data metrics and visualizations
        
        ### Step 3: Analysis
        1. Examine time series charts of solar power, irradiance, and temperature
        2. View seasonal patterns of solar generation
        ...
        - **Panel Area:** Calculated as Panel Capacity / (1 kW/m² × Efficiency)
        - **Daily Energy:** Irradiance × Panel Area × Efficiency
        - **Adjustments:** Temperature efficiency, cloud reduction, monsoon effects
        - **Range:** Clipped to realistic maximum (panel capacity × 8 hours)
        
        ### Limitations
        - Historical data availability depends on API access
        - Synthetic data is generated based on location patterns
        ...
        4. Renewable Energy Forecasting Methods
        ...
        - Validate assumptions for specific applications
